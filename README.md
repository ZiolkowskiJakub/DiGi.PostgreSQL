...
**DiGi.PostgreSQL** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.PostgreSQL.PartitionReference](DiGi.PostgreSQL.PartitionReference)** (Path: `DiGi.PostgreSQL\DiGi.PostgreSQL.PartitionReference`)
* **[DiGi.PostgreSQL.PartitionUniqueReference](DiGi.PostgreSQL.PartitionUniqueReference)** (Path: `DiGi.PostgreSQL\DiGi.PostgreSQL.PartitionUniqueReference`)
* **[DiGi.PostgreSQL.Table](DiGi.PostgreSQL.Table)** (Path: `DiGi.PostgreSQL\DiGi.PostgreSQL.Table`)
* **[DiGi.PostgreSQL.UniqueReference](DiGi.PostgreSQL.UniqueReference)** (Path: `DiGi.PostgreSQL\DiGi.PostgreSQL.UniqueReference`)
* **[DiGi.PostgreSQL](DiGi.PostgreSQL)** (Path: `DiGi.PostgreSQL\DiGi.PostgreSQL`)
